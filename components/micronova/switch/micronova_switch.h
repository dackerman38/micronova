...
class MicroNovaSwitch : public Component, public switch_::Switch, public MicroNovaSwitchListener {
 public:
  ...
  void set_memory_add_on(uint8_t f) { this->memory_add_on_ = f; }
  uint8_t get_memory_add_on() { return this->memory_add_on_; }

  void set_memory_add_off(uint8_t f) { this->memory_add_off_ = f; }
  uint8_t get_memory_add_off() { return this->memory_add_off_; }
